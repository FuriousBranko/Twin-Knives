...
<head>
	<meta charset="utf-8">
	<title>Menu | YG Restaurant</title>
...
<body>
	...
	<section id="menu-page-about" style="background-image:url('images/banner3.jpg'); width: 100%; background-repeat: no-repeat; background-size: cover; background-position: left;">
					...
					<div class="row">
						<div class="col-md-12 menu-listing-3 menu-item">
							...
							<div class="menu-image">
								<img src="images/thumb4.jpg" alt="menu image" class="img-responsive">
							</div>
							<div class="menu-content">
								<h4><a href="detail-page.html">Lorem Ipsum Dolor</a></h4>
								<p>Nemo enim ipsam vol.</p>
							</div>
							<div class="price">
								<p>$10</p>
							</div>
...
<!-- Mirrored from demo.drupalfreethemes.com/drupal/free-themes-html/yg-restaurant/dark/menu.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Dec 2018 21:20:46 GMT -->
